...
def split_pdf(input_pdf, output_folder="split_pages"):
    ...
    # Open the folder after saving the files
    if os.name == "nt":
        os.startfile(pdf_folder)  # Windows
    else:
        os.system(f"xdg-open {pdf_folder}")  # macOS/Linux

    return output_paths

# Example usage
pdf_file = "input/pdf/DataTables.pdf"  # Path to your input PDF
