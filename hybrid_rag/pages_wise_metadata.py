...
class PDFProcessor:
    ...
    def index_pdf(self, folder_path: str, category: str, force_reindex: bool = False): 
    ...
    def setup_retrieval_qa(self, model_name: str = "llama2"):
    ...
    def ask_question(self, question: str, model_name: str = "gemma3:4b") -> dict:
        """
...
# Index all folders in the output directory
processor.index_pdf("/Users/hemanathan/Desktop/Documents/IO/output/DataTables","Employee Data base")
...
def interactive_qa():
    ...
    while True:
        ...
        if user_input.lower() == 'switch model':
            models = ['gemma3:4b', 'llama2', 'mistral', 'neural-chat']
